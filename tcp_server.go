...
func control_process_tcp() {
	...
	listen_address := fmt.Sprintf("127.0.0.1:%d", Global.Global_constant_config.Tcp_port)
	listen := utils.Retry_task(task_net_listen, Global.Globalsig_ss, listen_address).(net.Listener)
